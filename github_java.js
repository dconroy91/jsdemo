...
var wordArray = ["hi","my","name","is","devin"]
...
var birthYear = 1991;
if (1966 >= birthYear && birthYear <= 1976) {
    console.log ("Nice, youre gen X")
}

else if (1977 <= birthYear && birthYear <= 1994) {
    console.log ("Nice, youre a millenial")
}

if (1995 <= birthYear && birthYear <= 2020) {
    console.log ("Nice, youre gen z")
}
...
if (gradeScore >= 0 && gradeScore <= 69) {
    console.log ("you got an F")
}

if (gradeScore >= 70 && gradeScore <= 76) {
    console.log ("you got a D")
}

if (gradeScore >= 77 && gradeScore <= 84) {
    console.log ("you got a C")
}

if (gradeScore >= 84 && gradeScore <= 92) {
    console.log ("you got a B")
}

if (gradeScore >= 93 && gradeScore <= 100) {
